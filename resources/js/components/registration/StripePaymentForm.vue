...
<template>
  <div>
    ...
    <button v-show="!this.form.busy || !this.form.submitted" type="button" class="btn btn-primary" id="checkout-button" dusk="checkout-button" @click="checkout" :disabled="this.displayTotal == 0 || (this.form.busy && !this.form.submitted)">Pay and Register for ${{displayTotal}}</button>
    <button v-show="this.form.submitted" class="btn btn-success"><i class="far fa-spinner fa-spin"></i> Processing...</button>
